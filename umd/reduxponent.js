(function (global, factory) {
	...
	(global.Reduxponent = factory(global.React));
...
var addISOYears$1 = convertToFP(addISOYears, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var addISOYearsWithOptions = convertToFP(addISOYears, 3);
...
var differenceInCalendarISOYears$1 = convertToFP(differenceInCalendarISOYears, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var differenceInCalendarISOYearsWithOptions = convertToFP(differenceInCalendarISOYears, 3);
...
var differenceInISOYears$1 = convertToFP(differenceInISOYears, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var differenceInISOYearsWithOptions = convertToFP(differenceInISOYears, 3);
...
function differenceInMinutes (dirtyDateLeft, dirtyDateRight, dirtyOptions) {
  ...
  var diff = differenceInMilliseconds(dirtyDateLeft, dirtyDateRight, dirtyOptions) / MILLISECONDS_IN_MINUTE$5;
  return diff > 0 ? Math.floor(diff) : Math.ceil(diff)
}
...
var endOfISOYear$1 = convertToFP(endOfISOYear, 1);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var endOfISOYearWithOptions = convertToFP(endOfISOYear, 2);
...
function getISOWeeksInYear (dirtyDate, dirtyOptions) {
  ...
  // because the number of milliseconds in a week is not constant
  // (e.g. it's different in the week of the daylight saving time clock shift)
  return Math.round(diff / MILLISECONDS_IN_WEEK$4)
}
...
var getISOYear$1 = convertToFP(getISOYear, 1);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var getISOYearWithOptions = convertToFP(getISOYear, 2);
...
var isEqual$1 = convertToFP(isEqual, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var isEqualWithOptions = convertToFP(isEqual, 3);
...
var isSameISOYear$1 = convertToFP(isSameISOYear, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var isSameISOYearWithOptions = convertToFP(isSameISOYear, 3);
...
var lastDayOfISOYear$1 = convertToFP(lastDayOfISOYear, 1);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var lastDayOfISOYearWithOptions = convertToFP(lastDayOfISOYear, 2);
...
var parse$1 = convertToFP(parse, 3);
...
var setISOYear$1 = convertToFP(setISOYear, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var setISOYearWithOptions = convertToFP(setISOYear, 3);
...
var startOfISOYear$1 = convertToFP(startOfISOYear, 1);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var startOfISOYearWithOptions = convertToFP(startOfISOYear, 2);
...
var subISOYears$1 = convertToFP(subISOYears, 2);

// This file is generated automatically by `scripts/build/fp.js`. Please, don't change it.

var subISOYearsWithOptions = convertToFP(subISOYears, 3);
...
var enUS$1 = unwrapExports(enUS);

var timeFmt = 'HH:mm:ss.SSS';
var dateToString = formatWithOptions({ locale: enUS$1 })(timeFmt);

var ACTION_COLOR = '#03A9F4';
var ACTION_LABEL = 'action';

var PREV_STATE_COLOR = '#9E9E9E';
var PREV_STATE_LABEL = 'prev state';

var NEXT_STATE_COLOR = '#4CAF50';
var NEXT_STATE_LABEL = 'next state';

var logUpdate = function logUpdate(_ref) {
  ...
  console.log('%c' + ACTION_LABEL, 'color: ' + ACTION_COLOR + '; ' + bold, action);
...
var Reduxponent = function (_Component) {
  inherits(Reduxponent, _Component);

  function Reduxponent(props) {
    classCallCheck(this, Reduxponent);
  ...
  Reduxponent.prototype.callReducer = function callReducer(action) {
    ...
    if (enableLogging && "development" !== 'production') {
  ...
  Reduxponent.prototype.getChildProps = function getChildProps() {
    ...
    var children = props.children,
        ...
        render = props.render,
        ownProps = objectWithoutProperties(props, ['children', 'enableLogging', 'initialState', 'lifecycle', 'mapActionCreatorsToProps', 'mapCustomDataTypesToLogging', 'mapStateToProps', 'name', 'reducer', 'render']);
...
var ReduxponentWrapper = function ReduxponentWrapper(props) {
  var name = props.name,
      ...
      rest = objectWithoutProperties(props, ['name', 'render', 'children', 'defaultProps']);

  var baseName = name || render && render.name || 'Reduxponent';

  var NamedReduxponent = function (_Reduxponent) {
    inherits(NamedReduxponent, _Reduxponent);

    function NamedReduxponent() {
      classCallCheck(this, NamedReduxponent);
      return possibleConstructorReturn(this, _Reduxponent.apply(this, arguments));
    }
  ...
  var Child = function Child(childProps) {
    return React__default.createElement(Render, childProps);
  };
  Child.displayName = baseName;

  return React__default.createElement(NamedReduxponent, _extends({}, defaultProps, rest, Render ? { render: Child } : {}));
};

return ReduxponentWrapper;
